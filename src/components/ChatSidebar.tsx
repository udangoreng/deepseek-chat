...
export const ChatSidebar = () => {
  ...
  const handleCreateThread = async () =>{
    const threadId = await db.createThreads(textInput);
  ...
  return (
    <>
      <Dialog open={dialogIsOpen} onOpenChange={setDialogIsOpen}>
        <DialogContent>
          ...
          <div className="space-y-1">
            <Label id="thread-title">Thread title</Label>
      ...
      <SidebarPrimitive>
        <SidebarHeader>
          <Button className="w-full justify-start" variant="ghost" onClick={()=> setDialogIsOpen(true)}>
